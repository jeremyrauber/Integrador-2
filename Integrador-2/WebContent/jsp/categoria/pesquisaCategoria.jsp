  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row marketing">
        ...
        <div id="pesquisa_nome" class="row">
	        <input type="text" name="fquery" id="fquery" placeholder="digite o nome da categoria" autocomplete="off"/>
	...
	$(document).ready(function(){
		...
		$("#search").click(function(){
			...
			$.ajax({
				method: "GET",
				url: "<%=request.getContextPath()%>/categoria",
